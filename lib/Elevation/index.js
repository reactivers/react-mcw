...
var Elevation = function (_PureComponent) {
    _inherits(Elevation, _PureComponent);
    ...
    _createClass(Elevation, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                style = _props.style,
                otherProps = _objectWithoutProperties(_props, ['zIndex', 'children', 'className', 'style']);

            return _react2.default.createElement(
                'div',
                _extends({ className: "mdc-elevation-transition mdc-elevation--z" + zIndex + " " + className, style: style }, otherProps),
                children
            );
        }
    }]);
...
Elevation.propTypes = {
    ...
    className: _propTypes2.default.number,
