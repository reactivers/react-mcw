...
AppBarTitle.propTypes = {
    iconAlignment: _react.PropTypes.string,
...
var AppBar = exports.AppBar = function (_React$PureComponent2) {
    ...
    _createClass(AppBar, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'header',
                { className: classes, style: barStyle },
...
AppBar.propTypes = {
    leftElements: _react.PropTypes.node,
    rightElements: _react.PropTypes.node,
    middleElements: _react.PropTypes.node,
