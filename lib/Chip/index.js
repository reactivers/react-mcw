    ...
    _createClass(Chip, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                otherProps = _objectWithoutProperties(_props, ['avatar', 'onCancel', 'style', 'avatarStyle', 'cancelButtonStyle', 'children']);

            return _react2.default.createElement(
                'div',
                _extends({ style: style, className: 'rmd-chip' }, otherProps),
                avatar && _react2.default.createElement(
                    'div',
                    { style: avatarStyle, className: 'rmd-chip-contact' },
                    avatar
                ),
...
Chip.propTypes = {
    ...
    avatarStyle: _react.PropTypes.object,
